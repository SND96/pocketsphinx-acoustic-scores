...
#define SWIGTYPE_p_int32 swig_types[22]
...
SWIGINTERN PyObject *_wrap_Segment_ascore_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (Segment *)(argp1);
  {
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Segment_ascore_set" "', argument " "2"" of type '" "int32""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "Segment_ascore_set" "', argument " "2"" of type '" "int32""'");
    } else {
      arg2 = *((int32 *)(argp2));
    }
  }
...
SWIGINTERN PyObject *_wrap_Segment_ascore_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (Segment *)(argp1);
  result =  ((arg1)->ascore);
  resultobj = SWIG_NewPointerObj((int32 *)memcpy((int32 *)calloc(1,sizeof(int32)),&result,sizeof(int32)), SWIGTYPE_p_int32, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_Segment_lscore_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (Segment *)(argp1);
  {
    res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_int32,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Segment_lscore_set" "', argument " "2"" of type '" "int32""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "Segment_lscore_set" "', argument " "2"" of type '" "int32""'");
    } else {
      arg2 = *((int32 *)(argp2));
    }
  }
...
SWIGINTERN PyObject *_wrap_Segment_lback_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (Segment *)(argp1);
  {
    res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_int32,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Segment_lback_set" "', argument " "2"" of type '" "int32""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "Segment_lback_set" "', argument " "2"" of type '" "int32""'");
    } else {
      arg2 = *((int32 *)(argp2));
    }
  }
...
SWIGINTERN PyObject *_wrap_Segment_prob_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (Segment *)(argp1);
  {
    res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_int32,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Segment_prob_set" "', argument " "2"" of type '" "int32""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "Segment_prob_set" "', argument " "2"" of type '" "int32""'");
    } else {
      arg2 = *((int32 *)(argp2));
    }
  }
...
SWIGINTERN PyObject *_wrap_NBest_score_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (NBest *)(argp1);
  {
    res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_int32,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "NBest_score_set" "', argument " "2"" of type '" "int32""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "NBest_score_set" "', argument " "2"" of type '" "int32""'");
    } else {
      arg2 = *((int32 *)(argp2));
    }
  }
